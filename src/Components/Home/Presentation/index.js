    ...
    return (
        <div className="presentation__container">
           ...
           <p className="presentation__para">
                    La reconversion professionnelle résulte de la volonté d'un individu, au cours de son activité, de changer de métier pour un toute nouvelle vie. C'est pour cela qu'après plusieurs années d'expérience dans l'aéronautique, j'ai souhaité me reconvertir dans le domaine du développement web.
